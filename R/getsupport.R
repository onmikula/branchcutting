...
#' @returns A numeric vector with supports for species defined in `species`.
#' @export
...
#' @param bc An object of class `bcut`.
#' @details The input `bcut` object must include component `psample`.
#' @returns A data frame with columns "ID" and "Species" defining the majority consensus delimitation.
#' @export
